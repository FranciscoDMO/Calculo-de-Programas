...
g_eval_exp x (Left ()) = x
g_evalexp  (Right (Left x)) = x
g_evalexp  (Right (Right (Left (Sum, (x, y))))) = x + y
g_evalexp  (Right (Right (Left (Product, (x, y))))) = x * y
g_evalexp  (Right (Right (Right (Negate, x)))) = -x
g_evalexp  (Right (Right (Right (E, x)))) = Prelude.exp x 
\end{verbatim}
