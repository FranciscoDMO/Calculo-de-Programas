...
\\
\>[B]{}\mbox{\onelinecomment prop_avg = nonempty .==>. diff .<=. const 0.000001 where}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment    diff l = avg l - (avgLTree . genLTree) l}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment    genLTree = anaLTree lsplit}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment    nonempty = (>[])}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\end{propriedade}
...
\\
\>[B]{}\mbox{\onelinecomment recExpAr= undefined}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\
...
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\
\>[B]{}\mbox{\commentbegin  g_eval_exp :: Floating a => a -> Either () (Either a (Either (BinOp, (a, a)) (UnOp, a))) -> a
...
g_eval_exp _ (Right (Right (Right (E, x)))) = Prelude.exp x  \commentend}{}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\mbox{\onelinecomment clean :: expAr a -> Either () (Either a (Either (BinOp, (a, a)) (UnOp, a)))}{}\<[E]%
\\
...
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment  clean == outExpAr}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment  apenas acrescentar absorçao }{}\<[E]%
\\
...
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment gopt = undefined }{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment  SE ja tiver a direita ja foi processado }{}\<[E]%
\\
\>[B]{}\mbox{\commentbegin 
sd_gen (Left ()) = (X, N 1)
sd_gen (Right (Left x)) = (N x, N 0)
sd_gen (Right (Right (Left (Sum, ((f, f'), (g, g')))))) = (Bin Sum f g, Bin Sum f' g')
sd_gen (Right (Right (Left (Product, ((f, f'), (g, g')))))) = (Bin Product f g, Bin Sum (Bin Product f g') (Bin Product f' g))
sd_gen (Right (Right (Right (Negate, (f, f'))))) = (Un Negate f, Un Negate f')
sd_gen (Right (Right (Right (E, (f, f'))))) = (Un E f, Bin Product (Un E f) f')  \commentend}{}\<[E]%
\\[\blanklineskip]%
...
ad_gen a (Right (Right (Left (Sum, ((f, f'), (g, g')))))) = (f + g, f' + g')
ad_gen a (Right (Right (Left (Product, ((f, f'), (g, g')))))) = (f * g, f * g' + f' * g)
ad_gen a (Right (Right (Right (Negate, (f, f'))))) = (-f, -f')
ad_gen a (Right (Right (Right (E, (f, f'))))) = (Prelude.exp f, f' * Prelude.exp f)
 \commentend}{}\<[E]%
\\[\blanklineskip]%
...
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment ad_gen a = undefined}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{cn}\;\mathrm{0}\mathrel{=}\mathrm{1}{}\<[E]%
\\
\>[B]{}\Varid{cn}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}\Varid{cn}\;\Varid{n}\mathbin{*}\Varid{a}\;\Varid{n}\div \Varid{b}\;\Varid{n}{}\<[E]%
\\[\blanklineskip]%
...
\\[\blanklineskip]%
\>[B]{}\Varid{loop}\;(\Varid{cn},\Varid{a},\Varid{b})\mathrel{=}(\Varid{cn}\mathbin{*}\Varid{a}\div \Varid{b},\mathrm{4}\mathbin{+}\Varid{a},\mathrm{1}\mathbin{+}\Varid{b}){}\<[E]%
\\
\>[B]{}\Varid{inic}\mathrel{=}(\mathrm{1},\mathrm{2},\mathrm{2}){}\<[E]%
\\
\>[B]{}\Varid{prj}\;(\Varid{cn},\Varid{a},\Varid{b})\mathrel{=}\Varid{cn}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
por forma a que
\begin{hscode}\SaveRestoreHook
...
\\
\>[B]{}\hsindent{7}{}\<[7]%
\>[7]{}\mathbf{where}\;\Varid{loop}\;(\Varid{cn},\Varid{a},\Varid{b})\mathrel{=}(\Varid{cn}\mathbin{*}\Varid{a}\div \Varid{b},\mathrm{4}\mathbin{+}\Varid{a},\mathrm{1}\mathbin{+}\Varid{b}){}\<[E]%
\\
\>[7]{}\hsindent{6}{}\<[13]%
\>[13]{}\Varid{inic}\mathrel{=}(\mathrm{1},\mathrm{2},\mathrm{2}){}\<[E]%
\\
\>[7]{}\hsindent{6}{}\<[13]%
\>[13]{}\Varid{prj}\;(\Varid{cn},\Varid{a},\Varid{b})\mathrel{=}\Varid{cn}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mbox{\onelinecomment avg_aux :: Ord a => [a] -> (a, a)}{}\<[E]%
\\
...
\\
\>[B]{}\hsindent{10}{}\<[10]%
\>[10]{}\mbox{\onelinecomment  q= split (uncurry div . split (add . split (mul . split (p1 . p2) (p2.p2)) (p1)) (succ.p2.p2)) (succ.p2.p2)}{}\<[E]%
\\
\>[10]{}\hsindent{1}{}\<[11]%
...
\\[\blanklineskip]%
\>[10]{}\hsindent{1}{}\<[11]%
\>[11]{}\mbox{\onelinecomment q= undefined}{}\<[E]%
\\
\>[B]{}\hsindent{10}{}\<[10]%
\>[10]{}\mbox{\onelinecomment  q(h,(a,l)) = ((a*l+h)/(l+1),l+1)}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{f}\;\Varid{x}\mathrel{=}(\Varid{x},\Varid{fromIntegral}\;\mathrm{1}){}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{g}\;((\Varid{a1},\Varid{c1}),(\Varid{a2},\Varid{c2}))\mathrel{=}(\Varid{add}\;((\Varid{product}\;[\mskip1.5mu \Varid{a1},\Varid{c1}\mskip1.5mu]),(\Varid{product}\;[\mskip1.5mu \Varid{a2},\Varid{c2}\mskip1.5mu]))\div \Varid{add}\;(\Varid{c1},\Varid{c2}),\Varid{add}\;(\Varid{c1},\Varid{c2})){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
